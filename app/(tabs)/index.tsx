...
const styles = StyleSheet.create({
  ...
  headline: { fontSize: 38, fontWeight: "800", color: Colors.white, lineHeight: 46, letterSpacing: -1, marginBottom: 16 },
  subtext: { fontSize: 15, color: "rgba(255,255,255,0.75)", lineHeight: 22, marginBottom: 24 },
  ctaRow: { flexDirection: "row", gap: 12, marginBottom: 24 },
  ctaPrimary: { flex: 1, minHeight: 48, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: Colors.secondary, paddingVertical: 14, paddingHorizontal: 16, borderRadius: Radius.xl, shadowColor: Colors.primary, shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.12, shadowRadius: 20, elevation: 6 },
  ctaPrimaryText: { color: Colors.white, fontWeight: "800", fontSize: 15 },
  ctaSecondary: { flex: 1, minHeight: 48, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 6, backgroundColor: Colors.card, paddingVertical: 14, paddingHorizontal: 16, borderRadius: Radius.xl, borderWidth: 1, borderColor: Colors.border },
  ctaSecondaryText: { color: Colors.primary, fontWeight: "800", fontSize: 15 },
  trustRow: { flexDirection: "row", alignItems: "center", gap: 12, flexWrap: "wrap" },
  trustItem: { flexDirection: "row", alignItems: "center", gap: 6 },
  trustText: { color: "rgba(255,255,255,0.78)", fontSize: 12, fontWeight: "500" },
  trustDivider: { width: 1, height: 12, backgroundColor: "rgba(255,255,255,0.24)" },
  statsBar: { flexDirection: "row", backgroundColor: Colors.card, borderRadius: Radius.xl, overflow: "hidden", maxWidth: 960, width: "100%", alignSelf: "center", ...Shadow.card },
  ...
  statLabel: { fontSize: 11, color: Colors.muted, fontWeight: "600", marginTop: 4 },
  section: { padding: 16, gap: 16, maxWidth: 960, width: "100%", alignSelf: "center" },
  sectionTitle: { fontSize: 18, fontWeight: "700", color: Colors.foreground, marginBottom: 4 },
  quickGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  quickCard: { flex: 1, minWidth: 140, backgroundColor: Colors.white, borderRadius: Radius.lg, padding: 20, alignItems: "center", gap: 12, borderWidth: 1, borderColor: Colors.border, ...Shadow.card },
  quickEmoji: { fontSize: 28 },
  quickLabel: { fontSize: 14, fontWeight: "600", color: Colors.foreground, textAlign: "center" },
  customersBg: { backgroundColor: Colors.mutedBg, paddingVertical: 24, borderTopWidth: 1, borderBottomWidth: 1, borderColor: Colors.border },
  customersHeader: { paddingHorizontal: 16, marginBottom: 16, maxWidth: 960, width: "100%", alignSelf: "center" },
  ...
  customersScroll: { paddingHorizontal: 16, gap: 12, flexDirection: "row" },
  customerChip: { backgroundColor: Colors.white, borderRadius: Radius.lg, padding: 16, alignItems: "center", width: 120, gap: 8, borderWidth: 1, borderColor: Colors.border, ...Shadow.card },
  customerLogoBox: { width: 60, height: 40, alignItems: "center", justifyContent: "center" },
  customerLogoImg: { width: 60, height: 40 },
  customerChipName: { fontSize: 11, fontWeight: "600", color: Colors.foreground, textAlign: "center", lineHeight: 14 },
  contactSub: { fontSize: 13, color: Colors.muted, lineHeight: 19, marginTop: -4, marginBottom: 4 },
  contactRow: { backgroundColor: Colors.white, borderRadius: Radius.lg, padding: 16, minHeight: 48, flexDirection: "row", alignItems: "center", gap: 12, borderWidth: 1, borderColor: Colors.border, ...Shadow.card },
  ...
  contactButtons: { gap: 12, marginTop: 4 },
  callBtn: { borderRadius: Radius.lg, overflow: "hidden", minHeight: 48, ...Shadow.soft },
  callBtnGrad: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, paddingVertical: 14, minHeight: 48 },
  callBtnText: { fontSize: 15, fontWeight: "700", color: Colors.white },
  whatsappBtn: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, paddingVertical: 14, minHeight: 48, borderRadius: Radius.lg, borderWidth: 2, borderColor: Colors.secondary, backgroundColor: Colors.white },
  whatsappBtnText: { fontSize: 15, fontWeight: "700", color: Colors.secondary },
  hoursCard: { backgroundColor: Colors.white, borderRadius: Radius.lg, padding: 20, borderWidth: 1, borderColor: Colors.border, ...Shadow.card, gap: 8 },
  hoursTitle: { fontSize: 14, fontWeight: "700", color: Colors.foreground, marginBottom: 2, marginTop: 4 },
  hoursText: { fontSize: 13, color: Colors.muted, lineHeight: 20 },
